...
public interface Pathes {
    ...
    public static final String FXML_MAIN_CONTROLLER_PATH = BASE
	    + "\\src\\main\\TestGui.fxml";
    ...
    public static final String RIGHT_ANSWER_IMAGE_PATH = BASE
	    + "\\src\\main\\rightAnswer.jpg";
    public static final String WRONG_ANSWER_IMAGE_PATH = BASE
	    + "\\src\\main\\wrongAnswer.jpg";

    public static final String[] IMAGES = { RIGHT_ANSWER_IMAGE_PATH,
